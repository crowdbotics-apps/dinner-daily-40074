"""
Django settings for dinner_daily_40074 project.
...
ROOT_URLCONF = 'dinner_daily_40074.urls'
...
WSGI_APPLICATION = 'dinner_daily_40074.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dinner_daily_40074 API",
    "DESCRIPTION": "API documentation for dinner_daily_40074 App",
    "VERSION": "v1",
}
